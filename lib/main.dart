...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  late Animation<double> _counterClockWiseRoationAnimation;
  ...
  void initState() {
    ...
    _counterClockWiseRoationAnimation = Tween<double>(begin: 0, end: -(pi / 2))
    ...
    _flipController.addStatusListener((status) { 
      if (status == AnimationStatus.completed) {
        _counterClockWiseRoationAnimation = Tween<double>(
                begin: _counterClockWiseRoationAnimation.value,
                end: _counterClockWiseRoationAnimation.value - (pi / 2))
            .animate(CurvedAnimation(
                parent: _counterClockWiseRotationController,
                curve: Curves.bounceOut));
            ...
            builder: (context, child) {
              return Transform(
                ...
                transform: Matrix4.identity()
                  ..rotateZ(_counterClockWiseRoationAnimation.value),
                child: Row(
